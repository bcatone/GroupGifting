...
ActiveRecord::Schema[7.1].define(version: 2024_02_20_014955) do
  ...
  create_table "friendship_connections", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["receiver_id"], name: "index_friendship_connections_on_receiver_id"
    t.index ["sender_id", "receiver_id"], name: "index_friendship_connections_on_sender_id_and_receiver_id", unique: true
    t.index ["sender_id"], name: "index_friendship_connections_on_sender_id"
  end
